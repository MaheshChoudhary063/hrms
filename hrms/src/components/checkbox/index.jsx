const Checkbox = (props) => {
  const { extra, color, label, error, ...rest } = props;
  return (
    <div className={`flex flex-col justify-between px-2 ${extra}`}>
      ...
      checked:border-none checked:text-white hover:cursor-pointer dark:border-white/10 ${
        color === "red"
          ? "border-red-500 checked:border-none checked:bg-red-500 dark:border-red-500 dark:checked:bg-red-400"
          : color === "blue"
          ? "border-blue-500 checked:border-none checked:bg-blue-500 dark:checked:bg-blue-400"
          : color === "green"
          ...
          : "checked:bg-brand-900 dark:checked:bg-brand-400"
      }`}
          {...rest}
        />
        {label && (
